...
### 3. Evaluate Results
After each Copilot execution, evaluate:
- **Goal Met?** Did Copilot do exactly what was asked?
- **Scope Intact?** Did Copilot add unrequested features or changes?
- **Redirection?** Did Copilot do something different than requested?
...
- Copilot is capable but needs direction to stay on track
- Your job is not to do the coding—it's to ensure Copilot does it correctly
